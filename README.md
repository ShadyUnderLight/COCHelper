...
- 随目录人工维护 `seasonal_phases.json`：阶段日期只采用 Supercell 官方公告；当前收录 2026-04-01 至 2026-07-30 的 Crafted Defenses 阶段与 2026-04-08 至 2026-04-29 的 Sound of Clash Medal Event（Party Wizard）阶段，旧快照可显示“已结束，仅历史数据”，未获官方精确日期的阶段保持“未配置”。
