...
/** Issue #145 / PR #249：本地计时容量类别（与 record.queueKind 自由字符串同构）。 */
...
/** PR #249：以稳定 item section 为准；未知 section fail-closed。 */
...
/** PR #249：assignment 同样从 itemKey 推导，不使用持久化 queueKind。 */
